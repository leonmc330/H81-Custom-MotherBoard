...
def normalize_refdes(ref: str) -> str:
    """Ensure refdes ends with a digit so KiCad won't re-annotate it."""
...
def component_uid(refdes: str) -> str:
    """Deterministic UUID from refdes — identical across PCB and schematic generators."""
